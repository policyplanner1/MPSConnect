...
function CityInput({
  ...
  function selectCity(city: string) {
    onChange(city.charAt(0).toUpperCase() + city.slice(1));
    setShowList(false);
  }
          ...
          {filtered.map((city, i) => {
            ...
            return (
              <Pressable
                ...
                style={[
                  styles.cityItem,
                  i < filtered.length - 1 && styles.cityItemBorder,
                ]}>
                ...
                <View
                  style={[
                    styles.zoneBadge,
                    { backgroundColor: ZONE_COLORS[zone] + '20', borderColor: ZONE_COLORS[zone] + '60' },
                  ]}>
                  <Text style={[styles.zoneBadgeText, { color: ZONE_COLORS[zone] }]}>
                    Zone {zone}
                  </Text>
                </View>
              </Pressable>
